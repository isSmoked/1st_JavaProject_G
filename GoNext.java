...
public class GoNext extends JPanel{
	...
	// 근속측정용 변수
	private int workingDate = 0; // 나중에 EMPLO_ALL1에 입사일, 근속기간 추가후 개선
	...
	private JLabel lblFinOutput, lblshowExSpend, lblshowRealSpend, lblSetExSpend, 
			...
			lblShowResult, lblSetResult;
	private JLabel lblSetPrevMon;
	public JButton btnDaccord; public JLabel lblSetLog;
...
//		lblSetPrevMon.setText(curcurmon + " 만원");
...
//				 lblSetResult.setText(curMoney + " 만원");
	...
	public void importFinanceInfo() { 
		...
		System.out.println("con" + confidence);
