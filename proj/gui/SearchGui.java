...
public class SearchGui extends JFrame implements MouseListener, Runnable{
	...
	private int cid;  
	private int depNum = 0;   private String depStr;
	private int grdNum = 0;   private String grdStr;
	private int compNum = 0;  private String compStr;
	private int count = 0;
	
	private String Memid, MemDepWant, MemName, MemGrdCur, MemCompCur, MemDepCur, // 사번, 부서, 이름, 직급, 소속, 부서
				MemCharMath, MemCharServ, MemCharHand, MemCharIq, MemCharScien;  // 산술, 서비스, 손재주, 숙련도, 과학
	private String strOverall; // 오버롤
	...
	// MainFrame > ShowPanel에 데이터를 저장시키는 판넬
