...
//	}
	// **************************************************************
	public JPanel panel;
	private JLabel lblPolitical; // 메인제목 > 정책 탭
	private JButton btnDecrease, btnIncrease; // 증가 및  감소 버튼
	private JLabel lblShowCurrentWage, lblSetCurrentWage, // 현재 급료 보여주는 Label
		lblShowChangedWage, lblSetChangedWage, // 변경된 급료를 보여주는 Label
		lblShowCurrentConfi, lblSetCurrentConfi, // 현재 사기를 보여주는 Label
		lblShowChangedConfi, lblSetChangedConfi; // 변경된 사기를 보여주는 Label
	...
	public double notwage; // 비급여
	public double changeConfi; // 사기 변경
